...
from domain.modules.script_director.planners.smart_timeline_planner_module import plan_smart_timeline
...
class TestTimelinePlanning(unittest.TestCase):
    ...
    def test_exclude_background(self):
        ...
        bg_actions = [a for a in timeline.actions if a.layer_id == "BG" and a.action_type != ActionType.NONE]
