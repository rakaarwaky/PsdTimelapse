...
from domain.modules.pipeline_manager.rendering.layer_animation_service_module import (
    create_layer_animation_service,
)
...
def test_layer_animation_service():
    ...
    # Mock config
    config = LayerRenderConfig(canvas_width=100, canvas_height=100, fps=30)
    ...
    # Timeline info
    timeline_mock = {"start_frame": 0, "end_frame": 5, "total_frames": 10, "action": None}
